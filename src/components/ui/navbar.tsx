              ...
              return (
                <a
                  ...
                  className={cn(
                    ...
                    "hover:bg-neutral-100 dark:hover:bg-neutral-800 active:scale-95 block",
                    isActive ? "hover:bg-transparent dark:hover:bg-transparent" : ""
                  )}
                >
                  <span className={cn(
                  ...
                  {isActive && (
                    <motion.div
                      ...
                      className="absolute inset-0 bg-[#565bac] rounded-full z-0 shadow-md"
